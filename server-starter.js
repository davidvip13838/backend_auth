...
// A: To prevent the original password from being stored in the database in plain text.

// Q2: Can you reverse a bcrypt hash to get the original password?
// A: No, you cannot reverse a bcrypt hash to get the original password.

// Q3: What does the number 10 in bcrypt.hash(password, 10) mean?
// A: The number 10 is the number of salt rounds.

// Q4: Why do we use bcrypt.compare() instead of comparing strings directly?
// A: To compare the provided password with the hashed password in the database.

// Q5: What happens if two users have the same password?
// A: The two users will have the same hashed password.
// ============================================================================
